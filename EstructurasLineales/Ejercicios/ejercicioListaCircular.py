...
lista_reproduccion.agregar_cancion("After Hours","4:00")
lista_reproduccion.agregar_cancion("Hotel California","5:00")
lista_reproduccion.agregar_cancion("Nuestra Afliccion","4:00")
