...
def external_direct_merge_sort(input_file_path, output_file_path):
    ...
    if temp_file_paths:
        ...
        print(f"Archivo Creado Exitosamente: {output_file_path}")

# Uso del programa
input_file_path = r"C:\Users\HOME\Desktop\100Original.txt"
output_file_path = 'Palabras_Ordenadas2.txt'
...
ruta_archivo = r'C:\Users\HOME\Desktop\100Original.txt'

# Leer el archivo y dividir el texto en palabras
with open(ruta_archivo, 'r') as f:
    palabras = f.read().split()

print("\nOrdenado por: BUBBLESORT\n")
print(palabras)
