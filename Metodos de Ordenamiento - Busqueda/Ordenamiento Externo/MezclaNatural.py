# Hacer un programa que ordene un archivo de texto grande con palabras,
# que será ordenado por el algoritmo de mezcla natural.
...
# Ejemplo de uso
archivo_entrada = r'C:\Users\HOME\Desktop\Lorem.txt'
